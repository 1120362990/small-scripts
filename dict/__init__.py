...
class Dict:
    ...
    def parse(self):
        ...
        if code == 0:  # Success
            ...
            if u != 'None':
                print(u'#  (U: {0} E: {1})'.format(u, e))
            elif c != 'None':
                print(u'#  (Pinyin: {0})'.format(c))
            else:
                print('# ')
            ...
            if explains != 'None':
                for i in range(0, len(explains)):
                    print(u'#  {0}'.format(explains[i]))
            else:
                print(u'#  Explains None')
            ...
            print(u'################################### ')
            fopen = open("F:\OneDrive\zhimi_words.txt", "a",encoding='utf-8')
            fopen.write( u'{0}'.format(self.content['query'])+'\n')
            fopen.close()
            # Phrase
